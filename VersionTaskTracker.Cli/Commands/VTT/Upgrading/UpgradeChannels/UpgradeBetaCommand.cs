...
[Command("upgrade beta", Description = "Upgrades to the latest version in the beta channel.")]
public class UpgradeBetaCommand : ICommand
{
    public UpgradeBetaCommand() { }
    ...
    public ValueTask ExecuteAsync(IConsole console)
    {
        ...
        var Version = UpgradeService
            ...
            .Result.Where(v => Regex.IsMatch(v, @"^v\d+\.\d+\.\d+-beta$"))
            .OrderDescending()
            .First();
