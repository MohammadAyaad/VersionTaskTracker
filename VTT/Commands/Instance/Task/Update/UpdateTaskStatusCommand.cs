...
public class UpdateTaskStatusCommand : ICommand
{
    ...
    [CommandParameter(1,Name = "New status",Description = "the task's new status",IsRequired = true)]
    ...
    public ValueTask ExecuteAsync(IConsole console)
    {
        ...
        (console,instance) => {
            ...
            if(Guid.TryParse(Id, out guid)) {
                ...
                console.Output.WriteLine($"{task.Label} {oldStatus} => {task.Label} {task.Status}");
                return ValueTask.CompletedTask;
            }
